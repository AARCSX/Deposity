...
func (h *Handler) Create(c *gin.Context) {
	...
	activity.LogActivity(h.db, activity.LogActivityParams{
		...
		EntityType:  "company",
		EntityID:    item.ID,
		Description: fmt.Sprintf("%s added party/client company %s", middleware.GetUserName(c), item.Name),
...
func (h *Handler) Update(c *gin.Context) {
	...
	activity.LogActivity(h.db, activity.LogActivityParams{
		...
		EntityType:  "company",
		EntityID:    item.ID,
		Description: fmt.Sprintf("%s updated company details for %s", middleware.GetUserName(c), item.Name),
		IPAddress:   c.ClientIP(),
	})
...
func (h *Handler) Delete(c *gin.Context) {
	...
	activity.LogActivity(h.db, activity.LogActivityParams{
		...
		EntityType:  "company",
		EntityID:    id,
		Description: fmt.Sprintf("%s deleted company record #%s", middleware.GetUserName(c), id),
		IPAddress:   c.ClientIP(),
	})
