  ...
  return (
    <>
      <div className="min-h-[70vh] flex flex-col items-center justify-center relative overflow-hidden px-4">
        ...
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-warning/10 rounded-full blur-3xl animate-pulse"></div>
        ...
        <div className="bg-surface-container-lowest/40 backdrop-blur-md rounded-[2.5rem] p-8 md:p-16 border border-outline-variant/15 shadow-2xl text-center max-w-2xl relative z-10 space-y-8">
          ...
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-3xl bg-linear-to-br from-warning to-primary text-white shadow-xl shadow-primary/20 animate-bounce duration-3000">
            <span className="material-symbols-outlined text-4xl">payments</span>
          </div>

          <div className="space-y-3">
            <span className="inline-block px-4 py-1.5 bg-warning/10 text-warning text-xs font-black uppercase tracking-widest rounded-full">
              Phase 2 Launch
            </span>
            <h1 className="text-4xl md:text-5xl font-black tracking-tight text-on-surface leading-tight">
              Expense Analytics <br />
              <span className="text-warning bg-clip-text">Coming Soon</span>
            </h1>
            <p className="text-on-surface-variant font-medium text-sm md:text-base max-w-md mx-auto leading-relaxed">
              We are constructing the Fleet Expenses & Fuel tracking ledger. Get ready for automated receipt OCR scanning, fuel card integrations, and route-wise profitability analytics.
            </p>
          </div>
          ...
          <div className="space-y-2 max-w-sm mx-auto">
            ...
            <div className="w-full h-3 bg-surface-container rounded-full overflow-hidden p-0.5 border border-outline-variant/10 shadow-inner">
              <div className="h-full bg-linear-to-r from-warning to-primary rounded-full w-[75%] relative">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
            ...
            <button 
              onClick={() => alert("You will be notified when the expenses engine is ready!")}
        ...
        <p className="text-xs text-outline font-semibold uppercase tracking-widest mt-12 relative z-10">
          AARCSX Deposity Ledger Engine v1.2
        </p>
      </div>
    </>
  );
